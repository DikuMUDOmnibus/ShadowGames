...
*/
 ...
 /*   { "auction",	do_auction,	POS_SLEEPING,	 0,  LOG_NORMAL},*/
    ...
    { "quest",          do_quest,       POS_SITTING,     2,  LOG_NORMAL },
   ...
   /* { "fileupdate",	do_fileupdate,	POS_DEAD,	12,  LOG_ALWAYS	},*/
    ...
    { "qtrust",         do_qtrust,      POS_DEAD,       10,  LOG_NORMAL },
    { "ntrust",         do_ntrust,      POS_DEAD,       10,  LOG_NORMAL },
    ...
    { "echo",           do_echo,        POS_DEAD,        8,  LOG_NORMAL },
...
bool check_xsocial( CHAR_DATA *ch, char *command, char *argument )
{
	...
	else
	{
		...
		if (!IS_EXTRA(victim, EXTRA_EXP))
		{
		    ...
		    victim->exp += 10; /*modified by cryic, was 100k*/
		}
	    }
	}
    }
